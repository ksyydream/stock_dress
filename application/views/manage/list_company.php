...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="delete" href="<?php echo site_url('manage/delete_company')?>/{id}" target="ajaxTodo"  title="确定要更改状态？" warn="请选择一条记录"><span>作废/启用</span></a></li>
        </ul>
    </div>
            ...
            if (!empty($res_list)):
                foreach ($res_list as $row):
                    ...
                    <tr target="id" rel=<?php echo $row->id; ?>>
                        ...
                        <td><?php
                            if($row->flag == 1){
                                echo '<font color="blue">启用服务</font>';
                            }else{
                                echo '<font color="red">暂停服务</font>';
                            }
                            ?></td>
                    </tr>
                    <?php
