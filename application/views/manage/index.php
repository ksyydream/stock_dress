		...
		<div id="leftside">
			...
			<div id="sidebar">
				...
				<div class="accordion" fillSpace="sidebar" >
					...
					<div class="accordionHeader">
						<h2><span>Folder</span>外包管理</h2>
					</div>
					<div class="accordionContent">
						<ul class="tree">
							<li><a href="<?php echo site_url('manage/list_company');?>" target="navTab" rel="list_company" onclick="close_all_navtab()">外包服务公司</a></li>
						</ul>
					</div>
					...
					<div class="accordionContent">
						<ul class="tree">
							<li><a href="<?php echo site_url('cust/list_cust');?>" target="navTab" rel="list_cust" onclick="close_all_navtab()">客户管理</a></li>
						</ul>
					</div>
				</div>
